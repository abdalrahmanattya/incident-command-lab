...
function Console({ authEnabled }: { authEnabled: boolean }) {
  ...
  return <div className="shell">
    ...
    <main className="content">
      ...
      <div className="grid two">
        <section className="panel"><PanelTitle title="Reservation exercise" kicker="03 / CUSTOMER PATH" /><ReservationForm state={state} reservation={reservation} setReservation={setReservation} setNotice={setNotice} /></section>
